...
pub(crate) struct Channel<T> {
    ...
    /// Laplace audit instrumentation for bounded channel critical sections.
    #[cfg(feature = "laplace")]
    laplace_inner: TrackedStdMutex<()>,
}
...
impl<T> Channel<T> {
    ...
    pub(crate) fn with_capacity(cap: usize) -> Self {
        ...
        Channel {
            ...
            #[cfg(feature = "laplace")]
            laplace_inner: TrackedStdMutex::new((), "crossbeam_array_inner"),
        }
    }
    ...
    fn start_send(&self, token: &mut Token) -> bool {
        #[cfg(feature = "laplace")]
        let _laplace_guard = self.laplace_inner.lock();
