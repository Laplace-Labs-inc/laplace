...
// Laplace 수정 고지: 실동작을 보존한 wrap-real 경로로 Tokio의 oneshot/watch/Notify와
// pingora-timeout을 Laplace async channel/Notify/time hook에 alias해 idle_timeout을 모델링한다.
...
mod tests {
    use super::*;
    use log::debug;
    // idle_poll tests are intentionally disabled: tokio-test Mock I/O is outside
    // the I/O-free idle_timeout protocol selected for this hunt.
    #[cfg(any())]
