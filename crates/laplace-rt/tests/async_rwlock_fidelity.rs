...
//! `tokio::sync::RwLock` (column A) and `laplace_rt::ModelAsyncRwLock`
...
async fn r6_send_parity_with_raw_tokio() {
    ...
    require_send::<laplace_rt::ModelAsyncRead<'static, u64>>();
    require_send::<laplace_rt::ModelAsyncWrite<'static, u64>>();
    require_send::<laplace_rt::ModelAsyncRwLockReadGuard<'static, u64>>();
    require_send::<laplace_rt::ModelAsyncRwLockWriteGuard<'static, u64>>();
