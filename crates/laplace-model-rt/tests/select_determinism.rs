...
//! Determinism gate for [`laplace_model_rt::laplace_select`] (AXM2 A2-4).
//!
...
//! is always respected; otherwise [`laplace_model_rt::deterministic_select_enabled`]
...
use laplace_model_rt::{deterministic_select_enabled, laplace_select, set_deterministic_select};
