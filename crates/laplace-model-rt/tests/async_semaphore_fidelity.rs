...
//! `tokio::sync::Semaphore` (column A) and `laplace_model_rt::ModelAsyncSemaphore`
...
async fn p8_send_parity_with_raw_tokio() {
    ...
    require_send::<laplace_model_rt::ModelSemaphoreAcquire<'static>>();
    require_send::<laplace_model_rt::ModelSemaphorePermit<'static>>();
